# -*- coding: utf-8 -*-
"""
Created on Wed Jul  1 14:15:46 2020
...
#读取csv,获取训练集和测试集
train_data = pd.read_csv('E:/data_mining/loudian_problem/data_hefei_yuchuli/dataset8_finaltrain.csv')
train_data.dropna(axis=0, how='any', inplace=True)
    
trainingSet = train_data.iloc[:,[3,4,5,6,7,8]]    
trainingLabels = train_data.iloc[:, 9]
#建立模型
...
X_train,X_test,y_train,y_test=model_selection.train_test_split(trainingSet,trainingLabels,test_size=0.2,random_state=0)
train_accuracy=alg.score(X_train,y_train)
validation_accuracy=alg.score(X_test,y_test)
